...
const AI_TOOLS_LIST: ToolCard[] = [
  {
    ...
    badge: "Most Popular",
    description:
      "Write one core idea or rough thought, and AI instantly generates optimized posts for Instagram, TikTok, X, LinkedIn, and YouTube.",
  ...
  },
  {
    ...
    badge: "99.4% Index",
    description:
      "Our model actively purges robotic AI clichés ('Delve into', 'In today's fast-paced world') and applies natural hooks, pacing, and human storytelling.",
  ...
  },
  {
    ...
    badge: "High CTR",
    description:
      "AI scores the scroll-stopping power of your opening lines before you publish, offering 3 high-converting alternative hooks.",
  ...
  },
  {
    ...
    badge: "Personalized",
    description:
      "Train the AI on your past top-performing content, newsletters, or blog. The AI adopts your exact humor, formatting, and vocabulary.",
  ...
  },
  {
    ...
    description:
      "AI continuously tracks when your exact followers on Instagram, TikTok, and X are most active, publishing precisely at the viral window.",
  ...
  },
  {
    ...
    badge: "Multi-Slide",
    description:
      "Converts long-form insights into swipeable 7-slide Instagram carousels and high-retention Twitter/X threads with seamless slide continuity.",
...
export default function AiToolsPage() {
  ...
  const [topicInput, setTopicInput] = React.useState(
    "How to scale from 0 to 100k followers without burnout",
  );
    ...
    <div className="relative overflow-hidden selection:bg-emerald-500 selection:text-white">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-16 pb-12 text-center relative z-10 space-y-4">
        ...
        <p className="text-sm sm:text-base md:text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto leading-relaxed">
          Say goodbye to robotic AI spam. SocialAI uses fine-tuned LLM models and vector voice
          profiles to craft viral hooks, auto-format for 5 platforms, and auto-schedule at
          algorithmic peaks.
        </p>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24 relative z-10 space-y-12">
        <div className="text-center max-w-2xl mx-auto space-y-3">
          ...
          <p className="text-sm sm:text-base text-zinc-600 dark:text-zinc-400 leading-relaxed">
            Every tool is purpose-built to eliminate manual creator grind, increase algorithmic
            reach, and protect your genuine brand voice.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            ...
            <p className="text-sm text-zinc-400 leading-relaxed">
              Experience ultra-fast generation speeds, end-to-end vector embeddings for your brand
              voice, and encrypted token management.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <div className="p-6 rounded-2xl bg-zinc-800/80 border border-zinc-700/80 space-y-3">
              ...
              <p className="text-xs text-zinc-400 leading-relaxed">
                Stores your creator brand voice in vector embeddings to ensure the AI never forgets
            ...
            <div className="p-6 rounded-2xl bg-zinc-800/80 border border-zinc-700/80 space-y-3">
              ...
              <p className="text-xs text-zinc-400 leading-relaxed">
                Your draft content and social credentials are encrypted with Supabase RLS and token
                rotation.
              </p>
            </div>
