...
import { Check, X as CrossIcon, Sparkles, ArrowRight, ShieldCheck } from "lucide-react";
...
const PLANS: PricingPlan[] = [
  ...
  },
  {
    ...
    popular: true,
    description:
      "For serious creators, founders & marketers aiming for daily multi-platform reach.",
    monthlyPrice: 19,
    annualPrice: 15,
    features: [
...
const COMPARISON_DATA: ComparisonCategory[] = [
  {
    ...
    features: [
      {
        name: "Monthly AI Post Generations",
        starter: "30 posts",
        pro: "Unlimited",
        agency: "Unlimited",
      },
      {
        name: "Unique Brand AI Voices",
        starter: "1 Profile",
        pro: "3 Profiles",
        agency: "Unlimited",
      },
  ...
  },
  {
    ...
    features: [
      ...
      {
        name: "Supported Networks (IG, TT, X, FB, YT)",
        starter: "2 Networks",
        pro: "All 5 Networks",
        agency: "All 5 Networks",
      },
    ...
    <div className="relative overflow-hidden selection:bg-emerald-500 selection:text-white">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-16 pb-12 text-center relative z-10 space-y-4">
        ...
        <p className="text-sm sm:text-base md:text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto leading-relaxed">
          Start for free, test our AI human-voice engine, and upgrade when you are ready to publish
          across 5 major platforms on total autopilot.
        </p>
        ...
        <div className="max-w-5xl mx-auto space-y-10">
          <div className="text-center space-y-2 max-w-xl mx-auto">
            ...
            <p className="text-xs sm:text-sm text-zinc-600 dark:text-zinc-400">
              Review every limit and capability to choose the exact plan that fits your content
              production workflow.
            </p>
          </div>
