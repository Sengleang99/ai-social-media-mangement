...
export const MOCK_GROWTH_DATA: GrowthDataPoint[] = [
  { date: "Aug 1", total: 4200, instagram: 1800, tiktok: 1600, x: 400, facebook: 300, linkedin: 100 },
  { date: "Aug 5", total: 6800, instagram: 2900, tiktok: 2600, x: 700, facebook: 450, linkedin: 150 },
  { date: "Aug 10", total: 11400, instagram: 4600, tiktok: 4800, x: 1100, facebook: 650, linkedin: 250 },
  { date: "Aug 15", total: 16200, instagram: 6800, tiktok: 6900, x: 1400, facebook: 800, linkedin: 300 },
  { date: "Aug 20", total: 22800, instagram: 9400, tiktok: 10100, x: 1900, facebook: 1000, linkedin: 400 },
  { date: "Aug 25", total: 29500, instagram: 12200, tiktok: 13400, x: 2300, facebook: 1150, linkedin: 450 },
  { date: "Aug 28", total: 38400, instagram: 15800, tiktok: 17800, x: 2800, facebook: 1400, linkedin: 600 },
];
...
export const MOCK_AI_INSIGHTS: AiInsight[] = [
  {
    ...
    description: "Your sourdough preparation posts generated 3.4x higher bookmark rates on Instagram and LinkedIn compared to simple photo bakes.",
    actionText: "Draft Next Carousel Episode",
    actionPrompt: "Create a 5-slide carousel revealing 3 common sourdough starter mistakes and how to fix them",
  },
  {
    id: "ins-2",
    type: "opportunity",
    title: "Tuesday 4:45 PM Commute Window is Untapped on TikTok",
    description: "Follower activity on TikTok spikes by +42% between 4:30 PM - 5:30 PM, but you currently have 0 posts scheduled in this slot.",
    actionText: "Schedule Peak Post",
    actionPrompt: "Create an evening bakery closing ASMR reel showing fresh warm baguettes coming out of stone ovens",
  },
  {
    id: "ins-3",
    type: "opportunity",
    title: "X (Twitter) Threads Converting High Click-Throughs",
    description: "Your business craftsmanship thread drove 182 reposts. Repurposing it into a LinkedIn newsletter format could unlock +2,000 professional impressions.",
    actionText: "Repurpose Thread to LinkedIn",
    actionPrompt: "Repurpose the craft bread versus industrial bread thread into an in-depth founder newsletter post",
  },
];
