...
const PLANS: PricingPlan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Connect All 5 Major Platforms",
      "Peak-Hour Auto-Timing Engine",
      "Visual Carousel & Slide Generator",
      "Human Authenticity Tone Optimizer",
  ...
  },
  {
    id: "agency",
    name: "Agency & Teams",
    description: "For agencies and growing marketing teams managing multiple accounts.",
    monthlyPrice: 49,
    annualPrice: 39,
    features: [
      "10 Brand Workspaces",
      ...
      "Custom Fine-Tuned AI Brand Training",
      "Bulk CSV / RSS Feed Auto-Import",
      "Advanced Impression Analytics & Heatmaps",
